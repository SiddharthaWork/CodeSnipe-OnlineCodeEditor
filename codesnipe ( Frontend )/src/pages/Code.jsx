...
export default function CreateProject() {
  ...
  return (
    <div className="w-full min-h-screen bg-black text-white ">
      ...
      <div className="max-w-8xl mx-[6rem] p-6 space-y-10">
        {/* Header */}
...
export const ImageCard = ({ images, loading }) => {
  ...
  return (
    ...
    {
      loading ? (
        <div className="grid md:grid-cols-2 xl:grid-cols-3 grid-cols-1 w-full gap-8 md:gap-10 xl:gap-12">
        ...
        <div className="grid place-items-center lg:grid-cols-2 2xl:grid-cols-3 grid-cols-1 w-full gap-8 md:gap-10 xl:gap-12 px-[2.5%]">
          ...
          ${hoveredCard === item._id ? "shadow-lg shadow-sky-600/20" : ""}`}
              ></div>
            </div>
          ))}
        </div>
